    ...
    <footer className="bg-fitgym-dark py-12 border-t border-fitgym-orange/20">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-base sm:text-lg font-bold text-white mb-4">Enlaces Rápidos</h4>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-white/50">
          <p className="text-xs sm:text-sm">&copy; 2025 FitGym. Todos los derechos reservados. | Diseñado con 💪 para transformar vidas</p>
        </div>
      </div>
    </footer>
  );
