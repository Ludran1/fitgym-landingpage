          ...
          <div className="space-y-6">
            <Card className="bg-gradient-accent border-none text-white shadow-intense">
              ...
              <CardContent className="space-y-4">
                ...
                <Button asChild className="w-full text-base sm:text-lg py-3 h-auto font-bold border-2 border-white bg-transparent text-white hover:bg-white hover:text-fitgym-orange transition-smooth">
                  <a href="https://wa.me/51960930024" target="_blank" rel="noopener noreferrer">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              ...
              <CardContent>
                <div className="flex justify-center space-x-4">
                  ...
                  <a 
                    href="https://www.tiktok.com/@fitgymsedeate" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-fitgym-orange rounded-full flex items-center justify-center hover:bg-fitgym-orange-light transition-smooth"
                  >
