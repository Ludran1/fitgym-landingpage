      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center lg:text-left">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <Button variant="outline-orange" size="lg" className="text-lg px-8 py-4 h-auto bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white hover:text-fitgym-dark">
          ...
          <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-white/20">
            <div className="text-center lg:text-left">
              <div className="text-3xl lg:text-4xl font-black text-fitgym-orange">500+</div>
              <div className="text-white/80 font-medium">Miembros Activos</div>
            </div>
            <div className="text-center lg:text-left">
              <div className="text-3xl lg:text-4xl font-black text-fitgym-orange">3+</div>
              <div className="text-white/80 font-medium">Años de Experiencia</div>
            </div>
            <div className="text-center lg:text-left">
              <div className="text-3xl lg:text-4xl font-black text-fitgym-orange">24/7</div>
              <div className="text-white/80 font-medium">Equipos Premium</div>
            </div>
          </div>
        </div>
      </div>
